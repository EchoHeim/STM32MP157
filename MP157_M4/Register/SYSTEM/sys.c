...
uint8_t sys_stm32_clock_init(uint32_t plln, uint32_t pllm, uint32_t pllp, uint32_t pllq, uint32_t pllfracv)
{
    ...
    rcc_osc_init_handle.LSIState = RCC_LSI_ON;        /* 打开LSI */
     ...
     *                             = 1066MHz
     */
    rcc_osc_init_handle.PLL2.PLLState = RCC_PLL_NONE;                /* 打开PLL2 */
     ...
     *                             ≈ 418MHz
     */
    rcc_osc_init_handle.PLL3.PLLState = RCC_PLL_NONE;                /* 打开PLL3 */
     ...
     *                             = 594MHz
     */
    rcc_osc_init_handle.PLL4.PLLState = RCC_PLL_NONE;                /* 打开PLL4 */
