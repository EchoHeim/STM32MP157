...
//emmc 文件系统
//#define CONFIG_BOOTARGS "console=ttySTM0,115200 root=/dev/mmcblk1p3 rootwait rw"
//sdcard 文件系统
#define CONFIG_BOOTARGS "console=ttySTM0,115200 root=/dev/mmcblk1p5 rootwait rw"

#define CONFIG_BOOTCOMMAND "load mmc 0:4  0xc4000000 stm32mp157d-biqu.dtb && load mmc 0:4  0xc2000000 uImage && bootm 0xc2000000 - 0xc4000000"
//#define CONFIG_BOOTCOMMAND "ext4load mmc 1:2 c2000000 uImage;ext4load mmc 1:2 c4000000 stm32mp157d-biqu.dtb;bootm c2000000 - c4000000"
//#define CONFIG_BOOTCOMMAND "setenv ethaddr 00:04:9f:04:d2:35;saveenv;tftp c2000000 uImage;tftp c4000000 stm32mp157d-biqu.dtb;bootm c2000000 - c4000000"

#define CONFIG_ENV_OVERWRITE	/* ethaddr can be reprogrammed */

// #define CONFIG_ETHADDR 00:04:9f:04:d2:35	//开发板网卡 MAC 地址
#define CONFIG_NETMASK 255.255.255.0		//开发板子网掩码
#define CONFIG_IPADDR 192.168.0.216 		//开发板 IP 地址
#define CONFIG_SERVERIP 192.168.0.156 		//服务器地址，也就是 Ubuntu 地址
#define CONFIG_GATEWAYIP 192.168.0.1 		//开发板默认网关

#define CONFIG_DNSIP 114.114.114.114 		//DNS 地址
...
#define CONFIG_CMD_BOOTD /* enable boot & bootd CMD */
