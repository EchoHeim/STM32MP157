					 ...
					 const struct i2c_device_id *id)
{
	...
	tsdata->irq_gpio = devm_gpiod_get_optional(&client->dev,"irq", GPIOD_OUT_HIGH);
    ...
    gpiod_direction_input(tsdata->irq_gpio);
...
*/
	...
	error = devm_request_threaded_irq(&client->dev, gpiod_to_irq(tsdata->irq_gpio),
